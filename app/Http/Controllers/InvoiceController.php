...
class InvoiceController extends Controller
{
    ...
    public function create()
    {
        ...
        // here we need to get products from table MULLANIE.dbo.Stockitem
        // $products = Product::all();
        // Ass soon as we have the table we can use this line
        // return view('invoice.create', compact('customers','products'));
        return view('invoice.create', compact('SLCustomerAccounts'));
    }
    ...
    public function edit($id)
    {
        ...
        // Here is to edit prodcust from table MULLANIE.dbo.StockItem
